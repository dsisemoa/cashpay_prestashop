...
class semoa_cashpayCallApiModuleFrontController extends ModuleFrontController
{   
    public $ssl = true;
    ...
    {   
        ...
        //Verifier si le module est activ� et si les infos du client sont valides
        if (!$this->module->active || $cart->id_customer == 0 || $cart->id_address_delivery == 0
            || $cart->id_address_invoice == 0) {
                Tools::redirect('index.php?controller=order&step=1');
            }
            
        //Verifie si le paiment est autoris�
      ...
      {   
          ...
          $this->logger->logInfo("[Payment]:getPaymentApiVars Recuperation des parametres API:".json_encode($paramsHeaders));
